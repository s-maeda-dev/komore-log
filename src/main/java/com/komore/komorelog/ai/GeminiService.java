...
public class GeminiService {
    ...
    public String getEmpathyReply(String userContent) {
        ...
        String instruction = "【設定: あなたは「komore」という名前の、心優しい癒やし系のパートナーです。】\n" +
        ...
        try {
            ...
            return "（komoreは優しく微笑んでいます。今は少しお話しするのが難しいみたいですが、あなたの言葉はちゃんと届いていますよ。）";
        } catch (Exception e) {
            return "（komoreは今、あなたの言葉を大切に心に刻んでいます。またあとで、ゆっくりお話ししましょうね。）";
        }
    }
}
